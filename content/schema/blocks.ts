...
//
// Точка может иметь необязательную координату z (глубина) — тогда чертёж
// стереометрический: рендерер проецирует (x,y,z) на экран кабинетной
// проекцией (ось z под 45° вправо-вверх, масштаб 0.5 — стандарт учебников
// стереометрии), а scripts/describe-geo-figure.ts считает РЕАЛЬНЫЕ длины/
// углы в 3D, а не по экранным координатам. Невидимые рёбра (за гранью
// фигуры) автор чертежа помечает вручную через style:"dashed", как и в
// плоских чертежах — автоматического определения видимости нет.
